...
<div class="data_list">
	...
	<div class="commentDatas">
		<c:choose>
			...
			<c:otherwise>
				<c:forEach var="comment1" items="${commentList}" varStatus="status">
					<c:choose>
						<c:when test="${status.index < 10 }">
							<div class="comment">
								<span><font>${status.index+1 }楼&nbsp;&nbsp;&nbsp;&nbsp;${comment1.userIp }：</font>${comment1.content}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[&nbsp;<fmt:formatDate
										value="${comment1.commentDate }" type="date"
